<div class="row">
	<div class="col-md-12 p-a-1"><h3>Add New Lecture</h3></div>
</div>
<div class="row">
    <div class="col-md-12 p-x-2">
        <form action="<?php echo base_url();?>index.php/admin/createLecture" method="post">
            <div class="row">
            ...
            <div class="row">
                <input type="submit" value="Create Lecture" class="p-a-1">
            </div>
        </form>
    </div>
</div>
