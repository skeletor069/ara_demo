...
?>
<div class="row">
	<div class="col-md-20 p-a-1"><h3>Update Post</h3></div>
</div>
<div class="row">
    <div class="col-md-7">
        <form action="<?php echo base_url();?>index.php/admin/updatePost" method="post">
            ...
            <div class="row">
                <input type="submit" value="Update Post" class="p-a-1">
            </div>
        </form>
    </div>
    <div class="col-md-5">
        <div class="col-md-12 m-b-1">
            <?php
                if($news["published"])
                    echo '<a class="btn-danger p-a-1" href="'.base_url().'index.php/admin/draftNews/'.$news["id"].'">Un-publish</a>';
                else {
                    if(sizeof($images) == 0)
                        echo '<a class="btn-primary p-a-1" href="#" onclick="alert(\'Upload image to make the news publishable.\');">Publish</a>';
                    else
                        echo '<a class="btn-primary p-a-1" href="' . base_url() . 'index.php/admin/publishNews/' . $news["id"] . '">Publish</a>';
                }
            ?>
        </div>
        <div class="col-md-12">
            <h4>Images of this post</h4>
        </div>
        <div class="col-md-12 m-y-2">
            ...
            if(sizeof($images) > 0)
                ...
                echo form_open_multipart('admin/newsUpload');
        ...
        <div class="col-md-12 card">
            ...
            foreach($images as $image){
                ?>
                <form action="<?php echo base_url();?>index.php/admin/deleteNewsImage" method="post">
                    <input type="hidden" name="post_id" value="<?php echo $news["id"];?>">
                    <input type="hidden" name="image_id" value="<?php echo $image["image_id"];?>">
                    <input type="hidden" name="url" value="<?php echo $image["image_path"];?>">
                    <div class="col-md-4">
