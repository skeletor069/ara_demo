...
<div class="row page_content pre-scrollable" style="min-height: 400px;height: 400px;">
    ...
    <div class="msrItems">
        ...
        foreach ($all_projects as $project){?>
            ...
            <a href="<?php echo base_url()."index.php/projects/projectsByCategory/".$project['default_category'];?>">
                <div class="msrItem">
                    <img class="msrImg" src="<?php echo base_url().$project["images"][0]["image_path"];?>" width="100%"/>
                </div>
            </a>
            <?php
        }
